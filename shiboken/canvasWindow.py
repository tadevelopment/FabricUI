...
class CanvasWindow(DFG.DFGMainWindow):
    ...
    def __init__(self, settings, unguarded):
        ...
        self.init(settings)
        self.initWindow()
        self.initKL(unguarded)
        self.initDFG()
        self.initTreeView()
        self.initGL()
        self.initValueEditor()
        self.initLog()
        self.initTimeLine()
        self.initDocksAndMenus()
    ...
    def initGL(self):
        ...
        self.viewport = Viewports.GLViewportWidget(self.client, self.config.defaultWindowColor, glFormat, None, None)
